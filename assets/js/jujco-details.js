...
(function () {
  ...
  var DATA = {
    ...
    "svc-rtu": {
      ...
      title: "Commercial Rooftop Units (RTUs)",
      lede: "Packaged rooftop heating and cooling for Edmonton corporate offices, retail plazas, and commercial facilities. Crane lifts, curb adapters, and zone balancing.",
      includeTitle: "What this commercial service includes",
      include: [
        "Commercial load sizing and roof-curb dimension audit",
        "Crane rigging, safety permits, and old unit haul-away",
        "Curb adapter fitting with weather-tight roof flashing",
        "Packaged gas heat and direct-expansion cooling commissioning",
    ...
    "svc-garage": {
      ...
      lede: "Gas and electric unit heaters professionally sized to turn your freezing Edmonton garage into a year-round workspace.",
      includeTitle: "What this service includes",
      include: [
        "Heater sizing against garage square footage and insulation",
        "New gas line running and electrical circuit testing",
        "Safe venting clearances according to Alberta code",
        "Thermostat wiring and optimal placement",
      ...
      when: [
        ...
        "An existing garage heater is blowing cold air or short-cycling",
        "You smell gas or notice strange noises from the unit",
      ],
    ...
    "prj-rtu": {
      theme: "hybrid",
      badge: "Project",
      title: "Commercial RTU Replacement — Edmonton",
      lede: "An ageing 15-year-old rooftop unit was leaving retail tenants freezing. We brought in a crane and installed a new packaged RTU.",
      includeTitle: "What changed",
      include: [
        "Packaged RTU and custom curb adapter",
        "Advanced free-cooling economizer",
        "Crane rigging and safe haul-away",
        "Even airflow across the retail space",
      ],
      whenTitle: "Similar job?",
      when: ["Rooftop unit is failing or short cycling", "Commercial tenants complain about drafts"],
